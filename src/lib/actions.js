...
export async function newJugador(formData) {
    try {
        ...
        const jugador = await prisma.jugador.create({
            data: {
                nombre, apellido, fechaNacimiento,lateralidad,
                genero, localidad, telefono, tallaCamiseta, tallaSudadera,
                email1, notas, fechaExamenMedico
            },
        })
    ...
    try {
        const jugador = await prisma.jugador.update({
            ...
            data: {
                ...
                lateralidad, genero, localidad, telefono,
                tallaCamiseta, tallaSudadera, email1, notas,
                fechaExamenMedico
            },
        })
    ...
    try {
        ...
        const entrenador = await prisma.entrenador.create({
            data: {
                ...
                telefono, tallaCamiseta, tallaSudadera,
                email1, titulacion, notas
            },
        })
