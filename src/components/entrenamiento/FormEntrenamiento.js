...
function Form({ children, action, entrenamiento, disabled = false }) {
    return (
        <form action={action} className="container mx-auto p-6 max-w-lg bg-blue-300 shadow-lg rounded-lg mt-8">
            ...
            <Suspense fallback={'Loading ...'}>
                <div className="mt-6">
                    ...
                    <div className="overflow-x-auto bg-blue-100 rounded-lg p-4 shadow-inner">
